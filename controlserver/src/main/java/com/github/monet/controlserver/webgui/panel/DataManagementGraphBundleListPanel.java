...
public class DataManagementGraphBundleListPanel extends ContentPanel {
	...
	public DataManagementGraphBundleListPanel() {
		...
		container.add(new ListView<BundleDescriptor>("list.graphbundle",
				bundleList) {
